...
public class MapController implements IMapController, OnFirstLayoutListener {
	 ...
	 */
	@Override
	public void animateTo(final IGeoPoint point, Point screenPoint, int animationDuration) {
		// If no layout, delay this call
		if (!mMapView.isLayoutOccurred()) {
	 ...
	 * Start animating the map from the geoPoint to the screenPoint.
	 */
	private void animateTo(int x, int y, Point screenPoint, int animationDuration) {
