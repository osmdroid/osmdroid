...
public class SegmentClipperTest {
	...
	public void test_clip_with_path() {
		...
		clippable.init();
		segmentClipper.clip(-2146, -2152, -145, -141, 0);
		...
		clippable.init();
		segmentClipper.clip(-145, -141, 855, -1150, 0);
		Assert.assertEquals(3, points.size());
		...
		clippable.init();
		segmentClipper.clip(1856, 267, -2146, 9434, 0);
		...
		clippable.init();
		segmentClipper.clip(-30, 500, 700, 800, 0);
		...
		clippable.init();
		segmentClipper.clip(-1000, -10000, 10000, 10000, 0);
		Assert.assertEquals(3, points.size());
		Assert.assertEquals(new PointL(-600, -600), points.get(0));
		...
		clippable.init();
		segmentClipper.clip(-10000, -1000, 10000, 10000, 0);
		Assert.assertEquals(3, points.size());
		Assert.assertEquals(new PointL(-600, -600), points.get(0));
