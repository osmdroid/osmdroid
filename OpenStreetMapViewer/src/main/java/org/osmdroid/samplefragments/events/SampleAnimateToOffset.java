 ...
 * @since 6.1.1
 */
public class SampleAnimateToOffset extends SampleMapEventListener {
    ...
    public String getSampleTitle() {
        return "Animate To with Offsets";
    }
    ...
    private void show(final int pIndex) {
        ...
        final Long speed = null;
        final Float orientation = null;
        final Boolean clockwise = null;
        final GeoPoint geoPoint = mList.get(pIndex % mList.size());
        mMapView.getController().animateTo(geoPoint, zoom, speed, orientation, clockwise, mOffsetX, mOffsetY);
    }
}
